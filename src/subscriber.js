...
const emitter = new EventEmitter(); //Creating a new emitter that forwards incoming MQTT messages as events
...
function startSubscription() {
    client.subscribe(access.FromClient); // from client to pipe
    client.subscribe(access.toRegistry); // from extractData to Registry component
}
